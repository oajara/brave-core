...
BatAdsClientMojoBridge::BatAdsClientMojoBridge(
  ...
  bat_ads_client_receiver_.Bind(std::move(client_info));
}
...
bool BatAdsClientMojoBridge::CanShowNotificationAdsWhileBrowserIsBackgrounded()
  ...
  bool can_show = false;
  bat_ads_client_receiver_->CanShowNotificationAdsWhileBrowserIsBackgrounded(
      &can_show);
  return can_show;
}
...
bool BatAdsClientMojoBridge::IsNetworkConnectionAvailable() const {
  ...
  bat_ads_client_receiver_->IsNetworkConnectionAvailable(&is_available);
  return is_available;
}
...
bool BatAdsClientMojoBridge::IsBrowserActive() const {
  ...
  bat_ads_client_receiver_->IsBrowserActive(&is_browser_active);
...
bool BatAdsClientMojoBridge::IsBrowserInFullScreenMode() const {
  ...
  bat_ads_client_receiver_->IsBrowserInFullScreenMode(
...
void BatAdsClientMojoBridge::ShowNotificationAd(
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->ShowNotificationAd(
        ads::NotificationAdToValue(ad));
  }
}
...
bool BatAdsClientMojoBridge::CanShowNotificationAds() {
  ...
  bool can_show = false;
  bat_ads_client_receiver_->CanShowNotificationAds(&can_show);
  return can_show;
}
...
void BatAdsClientMojoBridge::CloseNotificationAd(
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->CloseNotificationAd(placement_id);
  }
}
...
void BatAdsClientMojoBridge::RecordAdEventForId(
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->RecordAdEventForId(id, ad_type, confirmation_type,
                                                 time);
  }
}
...
std::vector<base::Time> BatAdsClientMojoBridge::GetAdEventHistory(
  ...
  bat_ads_client_receiver_->GetAdEventHistory(ad_type, confirmation_type,
                                              &ad_event_history);
...
void BatAdsClientMojoBridge::ResetAdEventHistoryForId(
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->ResetAdEventHistoryForId(id);
  }
}
...
void BatAdsClientMojoBridge::UrlRequest(
  ...
  bat_ads_client_receiver_->UrlRequest(
...
void BatAdsClientMojoBridge::Save(const std::string& name,
  ...
  bat_ads_client_receiver_->Save(name, value, std::move(callback));
}
...
void BatAdsClientMojoBridge::LoadFileResource(const std::string& id,
  ...
  bat_ads_client_receiver_->LoadFileResource(id, version, std::move(callback));
}
...
void BatAdsClientMojoBridge::GetBrowsingHistory(
  ...
  bat_ads_client_receiver_->GetBrowsingHistory(max_count, days_ago,
                                               std::move(callback));
}
...
void BatAdsClientMojoBridge::RecordP2AEvent(const std::string& name,
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->RecordP2AEvent(name, std::move(value));
  }
}
...
void BatAdsClientMojoBridge::LogTrainingInstance(
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->LogTrainingInstance(std::move(training_instance));
  }
}
...
void BatAdsClientMojoBridge::Load(const std::string& name,
  ...
  bat_ads_client_receiver_->Load(name, std::move(callback));
}
...
std::string BatAdsClientMojoBridge::LoadDataResource(const std::string& name) {
  ...
  std::string value;
  bat_ads_client_receiver_->LoadDataResource(name, &value);
  return value;
}
...
void BatAdsClientMojoBridge::RunDBTransaction(
  ...
  bat_ads_client_receiver_->RunDBTransaction(std::move(transaction),
                                             std::move(callback));
}

void BatAdsClientMojoBridge::ClearScheduledCaptcha() {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->ClearScheduledCaptcha();
  }
}
...
void BatAdsClientMojoBridge::GetScheduledCaptcha(
  ...
  bat_ads_client_receiver_->GetScheduledCaptcha(payment_id,
                                                std::move(callback));
}
...
void BatAdsClientMojoBridge::ShowScheduledCaptchaNotification(
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->ShowScheduledCaptchaNotification(
...
void BatAdsClientMojoBridge::Log(const char* file,
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->Log(file, line, verbose_level, message);
  }
}
...
bool BatAdsClientMojoBridge::GetBooleanPref(const std::string& path) const {
  ...
  bool value = false;
  bat_ads_client_receiver_->GetBooleanPref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetBooleanPref(const std::string& path,
                                            const bool value) {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetBooleanPref(path, value);
  }
}
...
int BatAdsClientMojoBridge::GetIntegerPref(const std::string& path) const {
  ...
  int value = 0;
  bat_ads_client_receiver_->GetIntegerPref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetIntegerPref(const std::string& path,
                                            const int value) {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetIntegerPref(path, value);
  }
}
...
double BatAdsClientMojoBridge::GetDoublePref(const std::string& path) const {
  ...
  double value = 0.0;
  bat_ads_client_receiver_->GetDoublePref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetDoublePref(const std::string& path,
                                           const double value) {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetDoublePref(path, value);
  }
}
...
std::string BatAdsClientMojoBridge::GetStringPref(
  ...
  std::string value;
  bat_ads_client_receiver_->GetStringPref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetStringPref(const std::string& path,
                                           const std::string& value) {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetStringPref(path, value);
  }
}
...
int64_t BatAdsClientMojoBridge::GetInt64Pref(const std::string& path) const {
  ...
  int64_t value = 0;
  bat_ads_client_receiver_->GetInt64Pref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetInt64Pref(const std::string& path,
                                          const int64_t value) {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetInt64Pref(path, value);
  }
}
...
uint64_t BatAdsClientMojoBridge::GetUint64Pref(const std::string& path) const {
  ...
  uint64_t value = 0;
  bat_ads_client_receiver_->GetUint64Pref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetUint64Pref(const std::string& path,
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetUint64Pref(path, value);
  }
}
...
base::Time BatAdsClientMojoBridge::GetTimePref(const std::string& path) const {
  ...
  base::Time value;
  bat_ads_client_receiver_->GetTimePref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetTimePref(const std::string& path,
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetTimePref(path, value);
  }
}
...
absl::optional<base::Value::Dict> BatAdsClientMojoBridge::GetDictPref(
  ...
  bat_ads_client_receiver_->GetDictPref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetDictPref(const std::string& path,
  ...
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetDictPref(path, std::move(value));
  }
}
...
absl::optional<base::Value::List> BatAdsClientMojoBridge::GetListPref(
  ...
  bat_ads_client_receiver_->GetListPref(path, &value);
  return value;
}
...
void BatAdsClientMojoBridge::SetListPref(const std::string& path,
                                         base::Value::List value) {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->SetListPref(path, std::move(value));
  }
}

void BatAdsClientMojoBridge::ClearPref(const std::string& path) {
  if (bat_ads_client_receiver_.is_bound()) {
    bat_ads_client_receiver_->ClearPref(path);
  }
}
...
bool BatAdsClientMojoBridge::HasPrefPath(const std::string& path) const {
  ...
  bool value = false;
  bat_ads_client_receiver_->HasPrefPath(path, &value);
  return value;
}
