...
export const mockNFTMetadata: NFTMetadataReturnType[] = [
  ...
  // AUDIO
  {
    ...
    imageMimeType: 'image/png',
    animationURL:
      'https://arweave.net/g1MGUZO3blCHhYIjqFbswqmp6cmWgAbueVUcnm8FvfQ',
  ...
  // VIDEO
  {
    ...
    tokenID: '0xBA7',
    imageURL:
      'https://ipfs.pixura.io/ipfs/QmdzCeMJ9Er4tWFJqUxYnMk7p6ob1DKs9zRpmw4E3KeUpG/GIF.gif',
    imageMimeType: 'image/gif',
    animationURL:
      'https://ipfs.pixura.io/ipfs/QmSWsRwmisz9QwmxNn9d1jh5CB1u9tzGw235jEuCpw3d6L/_AnimatormakingAnimationAll3.mp4',
  ...
  // HTML
  {
    ...
    contractInformation: {
      ...
      description:
        'Virtual Baroque by Pedro Gomes. Minted on December 11, 2021. Fully on-chain. Composed with Arpeggi Studio (arpeggi.io/genesis-studio).',
      website: '',
      twitter: '',
      facebook: '',
      logo: ''
  ...
  // 3D Model
  {
    ...
    animationURL:
      'https://openseauserdata.com/files/c3ba03ba3038e8c52ee9b2c58aece252.glb',
    ...
    contractInformation: {
      ...
      description:
        'A Japanese Cherry Blossom Tree made in Blender. This 3D model is custom made with detailed sculpting and hand painted textures. It can be used as a game object or to add to your 3D NFT collection!',
      website: '',
      twitter: '',
      facebook: '',
      logo: ''
