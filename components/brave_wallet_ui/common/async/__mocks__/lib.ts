...
export const getIsSwapSupported = (network: BraveWallet.NetworkInfo) =>
...
export const getBuyAssets = () =>
  new Promise<BraveWallet.BlockchainToken[]>((resolve) => {
    resolve(mockBuyAssetList)
  })

export const getAllBuyAssets = () =>
  new Promise<{
