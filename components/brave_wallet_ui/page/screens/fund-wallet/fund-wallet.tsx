...
export const FundWalletScreen = () => {
  ...
  const checkIsBuyAssetSelected = React.useCallback(
  ...
  React.useEffect(() => {
    if (tokenId !== undefined) {
      const foundBuyAsset = allBuyAssetOptions.find(
            ...
            <>
              <SelectAssetWrapper>
                <SwapInputComponent
                  ...
                  selectedNetwork={
                    selectedAssetNetwork || selectedNetworkFilter
                  }
                  autoFocus={true}
