...
export const BackupWalletRoutes = () => {
  ...
  return (
    <Switch>
      ...
      {hasMnemonic && (
        <Route path={WalletRoutes.BackupExplainRecoveryPhrase} exact>
          <RecoveryPhraseExplainer />
        </Route>
      )}

      {hasMnemonic && (
        <Route path={WalletRoutes.BackupRecoveryPhrase} exact>
          <BackupRecoveryPhrase />
        </Route>
      )}

      {hasMnemonic && (
        <Route path={WalletRoutes.BackupVerifyRecoveryPhrase} exact>
