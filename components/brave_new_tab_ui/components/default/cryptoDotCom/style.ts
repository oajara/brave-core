...
export const Text = styled('p')<StyleProps>`
  ...
  ${(p) => p.$p && `padding: ${typeof p.$p === 'number' ? `${p.$p}px` : p.$p}`}
  ${(p) =>
    p.$pt && `padding-top: ${typeof p.$pt === 'number' ? `${p.$pt}px` : p.$pt}`}
  ${(p) =>
    p.$pr &&
  ...
  ${(p) => p.$m && `margin: ${typeof p.$m === 'number' ? `${p.$m}px` : p.$m}`}
  ${(p) =>
    p.$mt && `margin-top: ${typeof p.$mt === 'number' ? `${p.$mt}px` : p.$mt}`}
  ${(p) =>
    p.$mr &&
  ...
  ${(p) =>
    p.$ml && `margin-left: ${typeof p.$ml === 'number' ? `${p.$ml}px` : p.$ml}`}
 `
...
export const FlexItem = styled('div')<StyleProps>`
  ...
  border-bottom: ${(p) =>
    p.hasPadding ? '1px solid rgba(79, 86, 97, 0.7)' : 'none'};
