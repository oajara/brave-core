...
#ifndef BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_REQUEST_OTR_SERVICE_H_
#define BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_REQUEST_OTR_SERVICE_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_REQUEST_OTR_SERVICE_H_
