...
#ifndef BRAVE_COMPONENTS_REQUEST_OTR_BROWSER_DOMAIN_BLOCK_TAB_STORAGE_H_
#define BRAVE_COMPONENTS_REQUEST_OTR_BROWSER_DOMAIN_BLOCK_TAB_STORAGE_H_
...
#endif  // BRAVE_COMPONENTS_REQUEST_OTR_BROWSER_DOMAIN_BLOCK_TAB_STORAGE_H_
