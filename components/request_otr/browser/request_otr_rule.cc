...
void RequestOTRRule::RegisterJSONConverter(
  ...
  converter->RegisterCustomValueField<extensions::URLPatternSet>(
      kInclude, &RequestOTRRule::include_pattern_set_, GetURLPatternSetFromValue);
  converter->RegisterCustomValueField<extensions::URLPatternSet>(
      kExclude, &RequestOTRRule::exclude_pattern_set_, GetURLPatternSetFromValue);
}

// static
const std::string RequestOTRRule::GetETLDForRequestOTR(const std::string& host) {
