          ...
          <CloseButton onClick={handleClose} aria-label="Close">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M2.172 12.26a.867.867 0 1 1-1.226-1.226L5.431 6.55 1.054 2.172A.867.867 0 1 1 2.28.946l4.377 4.378L11.034.946a.867.867 0 0 1 1.226 1.226L7.883 6.549l4.485 4.485a.867.867 0 0 1-1.226 1.226L6.657 7.775 2.172 12.26Z"
                fill="currentColor"
              />
            </svg>
          </CloseButton>
