...
function Container() {
  ...
  const { isConnected, isLoading, progress, message, connectionFailed } =
    useTorObserver()
  ...
  let dialogContent = (
    <p>
      {getLocale('headerText1')} {getLocale('headerText2')}
    </p>
  )
