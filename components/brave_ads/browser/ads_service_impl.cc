...
void AdsServiceImpl::OnInitializeBatAds(const bool success) {
  ...
  // TODO(tmancey): Bind BatAdsClientObservers here...
...
void AdsServiceImpl::OpenNewTabWithAd(const std::string& placement_id) {
  ...
  // TODO(tmancey): bat_ads_remote_->MaybeGetNotificationAd should be queued
...
// TODO(tmancey): Listen to observer
// void AdsServiceImpl::SetLocale(const std::string& locale) const {
//   VLOG(1) << "Locale changed to " << locale;
