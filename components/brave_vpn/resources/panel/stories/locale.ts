...
provideStrings({
  ...
  braveVpnUnableConnectInfo:
    "$1 couldn't connect to $2 server. You can try again, or choose another",
  ...
  braveVpnPurchaseFailed:
    'Unable to check the status of your purchase, probably a network problem, try again or contact support.',
  ...
  braveVpnSupportOptionalHeader:
    "Select the info you're willing to share with us",
  braveVpnSupportOptionalNotes:
