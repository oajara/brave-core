...
const localeData = {
  strings: {
    ...
    addFundsTermsOfSale:
      'By clicking Add Funds & Purchase, you agree to ' +
    ...
    confirmTermsOfSale:
      'By clicking Confirm, you agree ' + '$1Brave’s Terms of Sale$2.',
    useCreditCard: 'Use credit card',
    continueWithCreditCard: 'Continue with credit card',
    continueWithCreditCardMessage:
      'Make a one-time purchase using a credit card instead.',
    payWithBat: 'Pay with BAT',
    payWithBatTermsOfSale:
      'By clicking Pay with BAT, you agree to ' + '$1Brave’s Terms of Sale$2.',
    ...
    enableRewardsText:
      'To purchase this item, you need to earn tokens. Turn on Brave Rewards to earn.',
    enableRewardsLearnMore: 'Learn more.',
    enableRewardsButtonText: 'Enable Brave Rewards',
    enableRewardsTerms:
      'By clicking Enable Brave Rewards, you agree to $1Brave Reward’s Terms of Service$2.'
  },
  get(key: string) {
    ...
    <LocaleContext.Provider value={localeData}>
      ...
      >
        <PaymentMethodPanel
          ...
          walletBalanceConverted={knobs.text(
            'walletBalanceConverted',
            '$20.00'
          )}
          walletLastUpdated={knobs.text(
            'walletLastUpdated',
            'Today at 11:38 am'
          )}
  ...
  return (
    <LocaleContext.Provider value={localeData}>
      <DialogFrame showBackground={true} onClose={onDialogClose}>
        <EnableRewardsPanel onEnableRewards={actionLogger('onEnableRewards')} />
      </DialogFrame>
    </LocaleContext.Provider>
  )
}
...
export const loading = () => {
  return (
    <LocaleContext.Provider value={localeData}>
      <DialogFrame showTitle={true} onClose={onDialogClose}>
        <LoadingPanel text={knobs.text('text', 'Loading')} />
      </DialogFrame>
    </LocaleContext.Provider>
  )
}
