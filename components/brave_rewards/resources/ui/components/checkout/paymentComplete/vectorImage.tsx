  ...
  return (
    <svg width="120" height="111" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill-rule="nonzero" fill="none">
        ...
        <path
          d="M28.447 75.944l18.066-10.551 12.455-21.701V22.769c-.329 0-.657.217-.906.65L43.309 49.126 28.557 74.831c-.249.434-.272.827-.11 1.113"
          fill="#FF4724"
        />
        <path
          d="M58.968 22.769v20.923l12.454 21.7 18.066 10.552c.163-.286.14-.68-.109-1.113L74.627 49.125 59.874 23.42c-.25-.434-.578-.651-.906-.651"
          fill="#9E1F63"
        />
        <path
          d="M89.488 75.944L71.422 65.393H46.513L28.448 75.944c.162.288.513.466 1.011.466h59.017c.498 0 .849-.178 1.012-.466"
          fill="#662D91"
        />
