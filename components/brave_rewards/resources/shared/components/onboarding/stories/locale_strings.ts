...
export const localeStrings = {
  ...
  onboardingEarnText:
    'Earn tokens by viewing privacy-respecting ads and support your favorite sites and content creators automatically.',
  ...
  onboardingGeoText:
    'Select your country so we can show you the right options and ads for your region. $1Privacy Policy$2',
  ...
  onboardingSetupContributeHeader:
    'How much monthly support do you want to give to your favorite creators?',
  ...
  onboardingPanelCompleteText:
    'By using Brave Rewards you are helping make the web a better place for everyone. And that’s awesome!',
  onboardingPanelVerifyHeader: 'Verify',
  onboardingPanelVerifySubtext:
    'In order to withdraw the BAT you earn for viewing ads, you’ll need to verify Brave Rewards.',
  onboardingPanelVerifyLater: 'Do it later',
  onboardingPanelVerifyNow: 'Verify Brave Rewards',
  onboardingPanelBitflyerNote:
    'The bitFlyer wallet is a service managed by bitFlyer, Inc.',
  onboardingPanelBitflyerText:
    'By verifying your Brave Rewards and linking it to a bitFlyer account, you will be able to store and manage the tokens you have earned through Brave Rewards more easily',
  onboardingPanelBitflyerLearnMore:
    '$1Learn more$2 about how to link your Brave browser with your bitFlyer account.',
  ...
  braveTalkOptInRewardsTerms:
    'By enabling, you agree to the $1Terms of Service$2 and $3Privacy Policy$4.',
  ...
  braveTalkWantLearnMore:
    'Want to learn more about Brave Rewards? $1Take a quick tour$2.'
}
